...
window.Friday = {
  ...
  fieldLogEntries: [
    ...
    'Opossum 12-A: foraging. Heading: 247°. Pace: 0.3 m/s. Subject coordinates: 0 anomalies.',
    'opossum',
    ...
    'Note: one opossum appeared to look toward Subject coordinates. Filed: inconclusive.',
  ...
  papers: [
    ...
    {
      citation: 'Subject, B.G. & Marsupial Panel (2019). Continued Absence of Birthday Conditions: A 32-Year Longitudinal Study. <em>Journal of Temporal Mammalogy</em>, 44(2), 118–134.',
      abstract: 'We present 32 years of continuous field observation data regarding the birthday status of subject Ben. Results are consistent across all observation periods. The study period included the subject\'s actual birthday (July 5th) on 32 occasions, none of which were detected. Authors conclude: it is not his birthday. Continued observation is recommended. <strong>Note: Ben was listed as co-author in error. He is the subject, not a researcher. The Institute regrets this administrative oversight.</strong>',
    },
    {
      ...
      abstract: 'A meta-analysis of all OBRI publications from 1987 to 2021 was conducted. All 47 studies concluded it was not Ben\'s birthday. The pooled determination is: not his birthday. The author recommends further study.',
    },
    {
    ...
    {
      citation: 'Henwhistle, P.R., Voss, G.T., & Field Station Collective (2023). The Subject Coordinates: Eighteen Months of Intensive Perimeter Observation. <em>Journal of Applied Opossum Science</em>, 29(3), 44–61.',
      abstract: 'Following a grant renewal, OBRI intensified observation around the Subject Coordinates from January 2022 through June 2023. Opossum activity was logged at 15-minute intervals. No birthday was detected. Budget utilization: 94%. Remaining funds allocated to opossum enrichment.',
    },
    {
          ...
          <div class="ob-header-inner">
            <div class="ob-header-left">
              ...
              <div class="ob-header-text">
                ...
                <div class="ob-institute-address">47 Henwhistle Drive, Suite 3 &nbsp;·&nbsp; Vossfield, OH REDACTED &nbsp;·&nbsp; obri@obri-institute.edu</div>
              </div>
            </div>
        ...
        <div class="ob-content">
          ...
          <div class="ob-panel ob-panel-active" id="ob-panel-about">
            <div class="ob-two-col">
              <div class="ob-main-col">
                ...
                <p class="ob-body">The Opossum Behavioral Research Institute was founded in 1987 by Dr. Patricia R. Henwhistle, PhD, following a series of promising but inconclusive field observations near the known residential coordinates of one Ben. The Institute has maintained continuous field observation since that date, with a singular research objective: to determine, with scientific certainty, whether it is Ben's birthday.</p>
                ...
                <p class="ob-body">OBRI employs a proprietary observational framework known as the Subject Behavioral Inference Protocol (NBIP), which correlates opossum activity patterns near the Subject Coordinates with known festive atmospheric conditions. Field observers document opossum movement, sleep architecture, foraging behavior, and ambient vocalizations at 15-minute intervals, 24 hours per day.</p>
          ...
          <div class="ob-panel" id="ob-panel-sighting">
            ...
            <div class="ob-rejection-letter" id="ob-rejection-letter" style="display:none">
              ...
              <p class="ob-letter-body">After thorough review by our panel, your report has been assessed as <strong>INCONCLUSIVE</strong>. Specifically, the panel identified insufficient marsupial corroboration for the claimed birthday conditions. While we appreciate the detail provided, the opossum activity data submitted does not meet the evidentiary threshold established under the Subject Behavioral Inference Protocol (NBIP §4.2.1).</p>
